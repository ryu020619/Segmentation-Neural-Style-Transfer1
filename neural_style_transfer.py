...
def neural_style_transfer(config):
    ...
    dump_path = os.path.join(config['output_img_dir'], config['output_dir_name'])
...
if __name__ == "__main__":
    ...
    style_images_dir = os.path.join(default_resource_dir, 'my_style')
    ...
    parser.add_argument("--output_dir_name", type=str, help="output_dir_name")
    parser.add_argument("--height", type=int, help="height of content and style images", default=700)
